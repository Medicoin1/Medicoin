...
"Copyright &copy; 2011-YYYY The PYY developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About PYY", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>PYY</b> version", 0));
